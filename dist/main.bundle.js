...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return EndGameScene; });\n/* harmony import */ var _config_const_variable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config/const-variable */ \"./src/config/const-variable.js\");\n/* harmony import */ var _module_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../module/api */ \"./src/module/api.js\");\n\n\n\n// eslint-disable-next-line no-undef\nclass EndGameScene extends Phaser.Scene {\n  constructor() {\n    super('EndGame');\n  }\n\n  create() {\n    this.userModel = this.sys.game.globals.userModel;\n\n    this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) - 100, 'endGame').setScrollFactor(0);\n\n    this.replay = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2 - 125, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) + 100, 'replay').setScrollFactor(0).setInteractive();\n    this.replay.on('pointerdown', () => {\n      this.scene.start('Game');\n    });\n\n    this.menu = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 1.5) + 100, 'menu').setScrollFactor(0).setInteractive();\n    this.menu.on('pointerdown', () => {\n      this.scene.sendToBack('Game');\n      this.scene.start('Title');\n    });\n\n    this.submit = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2 + 125, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) + 100, 'submit').setScrollFactor(0).setInteractive();\n    this.submit.on('pointerdown', () => {\n      Object(_module_api__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('POST', this.userModel.user, this.userModel.score)\n        .then(() => {\n          this.scene.sendToBack('Game');\n          this.scene.start('Scores');\n        });\n    });\n    this.input.on('pointerover', (event, gameObjects) => {\n      gameObjects[0].setScale(1.1);\n    });\n\n    this.input.on('pointerout', (event, gameObjects) => {\n      gameObjects[0].setScale(1);\n    });\n  }\n}\n\n//# sourceURL=webpack:///./src/scenes/endGame.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ScoresScene; });\n/* harmony import */ var _config_const_variable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config/const-variable */ \"./src/config/const-variable.js\");\n/* harmony import */ var _module_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../module/api */ \"./src/module/api.js\");\n\n\n\n\n// eslint-disable-next-line no-undef\nclass ScoresScene extends Phaser.Scene {\n  constructor() {\n    super('Scores');\n  }\n\n  create() {\n    this.sys.canvas.style.cursor = 'progress';\n    let height = 50;\n    let bgTime = 1;\n    Object(_module_api__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('GET', 'Daniel', 114)\n      .then(data => {\n        data.sort((a, b) => b.score - a.score);\n        Object.keys(data).forEach((score, index) => {\n          if (height > _config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] * bgTime) {\n            this.bg = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) + height - 50, 'sky');\n            bgTime += 1;\n            if (bgTime % 2 === 0) {\n              this.bg.rotation = 3.14159;\n            }\n          }\n\n          this.img = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, height, 'emptyTag');\n\n          this.lbl = this.make.text({\n            text: `${index + 1} - `,\n            style: {\n              fill: '#422115',\n            },\n          });\n          this.lbl.x = this.img.x - (this.img.width / 2) + 15;\n          this.lbl.y = height;\n\n          this.display = this.make.text({\n            text: `${data[score].user} : ${data[score].score}`,\n            style: {\n              fill: '#422115',\n            },\n          });\n          this.display.x = this.lbl.x + this.lbl.width;\n          this.display.y = height;\n          height += 100;\n\n          if (index === data.length - 1) {\n            this.logo = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] - 68, _config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] - 34, 'logo').setScale(0.3).setScrollFactor(0);\n            this.sys.canvas.style.cursor = 'default';\n          }\n        });\n      });\n\n    this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2), 'sky');\n\n    this.gameBtn = this.add.image(110, 50, 'back').setInteractive();\n    this.gameBtn.on('pointerdown', () => {\n      this.scene.start('Title');\n    });\n\n    this.input.on('pointerover', (event, gameObjects) => {\n      gameObjects[0].setScale(1.1);\n    });\n\n    this.input.on('pointerout', (event, gameObjects) => {\n      gameObjects[0].setScale(1);\n    });\n\n    this.input.on('wheel', (pointer, gameObjects, deltaX, deltaY) => {\n      this.cameras.main.scrollY += deltaY * 10.5;\n      if (this.cameras.main.scrollY <= 0) {\n        this.cameras.main.scrollY = 0;\n      } else if (this.cameras.main.scrollY >= height - _config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"]) {\n        this.cameras.main.scrollY = height - _config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"];\n      }\n    });\n  }\n}\n\n//# sourceURL=webpack:///./src/scenes/score.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return TitleScene; });\n/* harmony import */ var _config_const_variable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config/const-variable */ \"./src/config/const-variable.js\");\n\n\n// eslint-disable-next-line no-undef\nclass TitleScene extends Phaser.Scene {\n  constructor() {\n    super('Title');\n  }\n\n  create() {\n    this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2), 'sky');\n    this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] - 68, _config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] - 34, 'logo').setScale(0.3);\n\n    this.soundModel = this.sys.game.globals.soundModel;\n    if (this.soundModel.musicOn === true && this.soundModel.bgMusicPlaying === false) {\n      this.bgMusic = this.sound.add('bgMusic', { volume: 0.5, loop: true });\n      this.bgMusic.play();\n      this.soundModel.bgMusicPlaying = true;\n      this.sys.game.globals.bgMusic = this.bgMusic;\n    }\n\n    this.gameBtn = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) - 210, 'playGame').setInteractive();\n    this.gameBtn.on('pointerdown', () => {\n      this.scene.start('User');\n    });\n\n    this.settingsBtn = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) - 100, 'settings').setInteractive();\n    this.settingsBtn.on('pointerdown', () => {\n      this.scene.start('Options');\n    });\n\n    this.gameBtn = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) + 20, 'scores').setInteractive();\n    this.gameBtn.on('pointerdown', () => {\n      this.scene.start('Scores');\n    });\n\n    this.settingsBtn = this.add.image(_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_WIDTH\"] / 2, (_config_const_variable__WEBPACK_IMPORTED_MODULE_0__[\"GAME_HEIGHT\"] / 2) + 130, 'credits').setInteractive();\n    this.settingsBtn.on('pointerdown', () => {\n      this.scene.start('Credits');\n    });\n\n    this.input.on('pointerover', (event, gameObjects) => {\n      gameObjects[0].setScale(1.1);\n    });\n\n    this.input.on('pointerout', (event, gameObjects) => {\n      gameObjects[0].setScale(1);\n    });\n  }\n}\n\n//# sourceURL=webpack:///./src/scenes/title.js?");
